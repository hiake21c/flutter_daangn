...
final post1 = ProductPost(product1.user, product1, '포스트 입니다1.', Address('서울특별시 송파구 잠실본동1', '서울시'), 10, 30, DateTime.now().subtract(30.minutes));
final post2 = ProductPost(product2.user, product2, '포스트 입니다2.', Address('대전광역시 송파구 잠실본동2', '대전시'), 11, 450, DateTime.now().subtract(5.minutes));
final post3 = ProductPost(product3.user, product3, '포스트 입니다3.', Address('부산특별시 송파구 잠실본동3', '부산시'), 12, 421, DateTime.now().subtract(10.seconds));
