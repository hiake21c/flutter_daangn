        ...
        pageBuilder: (BuildContext context, GoRouterState state) =>
            FadeTransitionPage(
              ...
              child: Container(color: Colors.green,
                child: Center(
                  child: RoundButton(text: '로그인',
                    onTap: (){
                      _auth.signIn('dummyUsername', 'veryStrongPassword');
                    }
                  ),
                ),
              ),
        ...
        routes: <GoRoute>[
          GoRoute(
            ...
            builder: (BuildContext context, GoRouterState state) {
              ...
              if(state.extra != null){
                return PostDetailScreen(int.parse(postId), simpleProductPost: state.extra as SimpleProductPost);
              }
