...
class _$SimpleProductPostImpl implements _SimpleProductPost {
  const _$SimpleProductPostImpl(this.id, this.user, this.product, this.title,
      this.address, this.chatCount, this.likeCount, this.createdAt);
  ...
  @override
  String toString() {
    return 'SimpleProductPost(id: $id, user: $user, product: $product, title: $title, address: $address, chatCount: $chatCount, likeCount: $likeCount, createdAt: $createdAt)';
  }
...
abstract class _SimpleProductPost implements SimpleProductPost {
  const factory _SimpleProductPost(
      ...
      final int chatCount,
      final int likeCount,
      final DateTime createdAt) = _$SimpleProductPostImpl;
